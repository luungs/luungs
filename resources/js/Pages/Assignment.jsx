...
export default function Assignment({ auth, assignment, message }) {
            ...
            <Layout>
                <div className='grid grid-cols-10 pt-5 gap-x-5'>
                    <div className='col-span-7'>
                        ...
                        {/* Message display */}
                        {message && <div className="mt-4 p-4 bg-blue-100 border border-blue-300 text-blue-700 rounded">{message}</div>}
